...
This process optionally uses Okta's flexible app profile, which accepts any JSON-compliant content, to create a allow list of Groups that can then easily be referenced.
...
The EL function format: `getFilteredGroups(allowlist, group_expression, limit)`
